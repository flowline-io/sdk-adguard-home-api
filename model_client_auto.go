...
// checks if the ClientAuto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClientAuto{}
...
func (o ClientAuto) ToMap() (map[string]interface{}, error) {
