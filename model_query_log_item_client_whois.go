...
// checks if the QueryLogItemClientWhois type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueryLogItemClientWhois{}
...
func (o QueryLogItemClientWhois) ToMap() (map[string]interface{}, error) {
