...
// checks if the DnsAnswer type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsAnswer{}
...
func (o DnsAnswer) ToMap() (map[string]interface{}, error) {
